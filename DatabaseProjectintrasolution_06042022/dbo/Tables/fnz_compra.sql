CREATE TABLE [dbo].[fnz_compra] (
    [fnz_compra_id]                 NUMERIC (10)    IDENTITY (1, 1) NOT NULL,
    ...
    [monto_otros_soles]             NUMERIC (15, 2) NULL,
    [monto_otros_dolares]           NUMERIC (15, 2) NULL,
    [monto_total_soles]             NUMERIC (15, 2) NULL,
    [monto_total_dolares]           NUMERIC (15, 2) NULL,
    ...
    [fnz_estado_compra_id]          NUMERIC (10)    NULL,
    ...
    CONSTRAINT [PK_fnz_compra] PRIMARY KEY CLUSTERED ([fnz_compra_id] ASC)
);
