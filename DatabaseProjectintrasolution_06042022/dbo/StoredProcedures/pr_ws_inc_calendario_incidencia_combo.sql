/**
NOMBRE: [dbo].[pr_ws_inc_calendario_incidencia_combo]
CREACION: 2022-01-09
AUTOR: Jorge Felix
DESCRIPCION: Retorna nombres y id de las incidencias donde el empleado es responsable para el webservice aplicacion movil
USADO POR: Registro de Tareas/Ejecución/Registro de Tareas
pr_ws_inc_calendario_incidencia_combo 16
**/


CREATE PROCEDURE [dbo].[pr_ws_inc_calendario_incidencia_combo]
