...
[dbo].[pr_inc_info_incidentes_por_confirmar] 1,0
...
CREATE procedure [dbo].[pr_inc_info_incidentes_por_confirmar]
...
WHERE
	is_deleted = 0 AND
	inc_estado_incidencia_id IN (5,6,7,8,10005) AND -- Post DMT
