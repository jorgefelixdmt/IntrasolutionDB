/**
NOMBRE: [dbo].[pr_ws_inc_calendario_subtipo_tarea_combo]
CREACION: 2022-01-09
AUTOR: Jorge Felix
DESCRIPCION: Retorna nombres y id de los subtipos de tareas
USADO POR: Registro de Tareas/Ejecución/Registro de Tareas
pr_ws_inc_calendario_subtipo_tarea_combo 3
**/

CREATE PROCEDURE [dbo].[pr_ws_inc_calendario_subtipo_tarea_combo]
