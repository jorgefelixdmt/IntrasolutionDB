...
<StoreProcedure>        
 <Name>        
         pr_aviso_documento_distribucion1      
   </Name>        
    <Description>        
  Alerta a los responsables que el documento ha sido actualizado        
...
*/        
--exec pr_aviso_documento_distribucion1         
CREATE proc [dbo].[pr_aviso_documento_distribucion1]         
...
inner join fb_empleado empleado on empleado.fb_area_id = ddd.fb_area_id and empleado.fb_cargo_id = ddd.fb_cargo_id and empleado.fb_uea_pe_id = ddd.fb_uea_pe_id      
inner join fb_uea_pe uea on uea.fb_uea_pe_id = ddd.fb_uea_pe_id      
