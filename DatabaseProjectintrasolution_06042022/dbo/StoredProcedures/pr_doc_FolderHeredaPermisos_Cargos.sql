...
CREATE PROC [dbo].[pr_doc_FolderHeredaPermisos_Cargos]        
(        
...
BEGIN        
 ...
 BEGIN        
  ...
  Delete doc_folder_permiso_cargo Where doc_folder_id = @Id_Folder        
        
  -- **** Copia los permisos del folder padre al folder hijo        
  INSERT INTO doc_folder_permiso_cargo         
   SELECT  doc_folder_id=@Id_Folder,        
     ...
     is_deleted=0        
    from doc_folder_permiso_cargo         
    Where doc_folder_id = @Id_Folder_Inicial        
        
  -- **** Ejecuta el proceso de Heredar para los folder nieto        
  EXEC dbo.pr_doc_FolderHeredaPermisos_Cargos @Id_Folder, @fb_usuario_id        
