...
[dbo].[pr_inc_info_incidentes_pendientes] 1,0
...
CREATE procedure [dbo].[pr_inc_info_incidentes_pendientes]
...
WHERE
	is_deleted = 0 AND
	inc_estado_incidencia_id NOT IN (9,10002) AND -- 10002:Culminado, 9:Anulado
