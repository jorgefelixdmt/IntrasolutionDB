CREATE FUNCTION [dbo].[uf_format_string_to_json] (@str varchar(8000)) 
RETURNS varchar(8000)
AS
BEGIN
     DECLARE @json_format varchar(8000);
     SET @json_format = @str
	 
	 SET @json_format = REPLACE( @json_format, '"', '\"')
     SET @json_format = REPLACE( @json_format, CHAR(10), '<br/>')
